		...
		<main>
			<div class= "container">
				...
				<form method="post" action="process.php">
					<ul class="choices">
					   <li><input name="choice" type="radio" id="a" value="a" required=""><?php echo $ans1; ?></li>
					   <li><input name="choice" type="radio" id="b" value="b" required=""><?php echo $ans2; ?></li>
					   <li><input name="choice" type="radio" id="c" value="c" required=""><?php echo $ans3; ?></li>
					   <li><input name="choice" type="radio" id="d" value="d" required=""><?php echo $ans4; ?></li>
